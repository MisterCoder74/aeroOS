...
Public Class html
    ...
    Private Sub Form1_Activated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Activated
        Me.Opacity = 1
    End Sub
    Private Sub html_Resize(sender As System.Object, e As System.EventArgs) Handles MyBase.Resize
        If Me.WindowState = FormWindowState.Minimized Then

            aero.htmlbuttonsmall.Visible = True
        End If
        If Me.WindowState = FormWindowState.Normal Then

            aero.htmlbuttonsmall.Visible = False
        End If
    End Sub

    Private Sub html_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        End Try
        WebBrowser1.Navigate(System.AppDomain.CurrentDomain.BaseDirectory() & "elrte\elrte.html")
    End Sub
End Class