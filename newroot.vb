...
Public Class newroot
    ...
    Private Sub Form1_Activated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Activated
        Me.Opacity = 1
    End Sub
    Private Sub newroot_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        rootbox.Text = My.Settings.rootdir
        rootlabelok.Text = ""
        rootlabelok.Visible = False
    End Sub
    ...
    Private Sub savebutton_Click(sender As System.Object, e As System.EventArgs) Handles savebutton.Click
        ...
        My.Settings.Reload()
        Me.Close()
        rootlabelok.Visible = True
        rootlabelok.Text = "New installation created"
    End Sub
End Class