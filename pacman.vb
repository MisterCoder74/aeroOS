...
Public Class pacman
    ...
    Private Sub LoadScoreTable()
        ...
        Dim FILENAME As String = (CurDir() & "\games\pacman\high scores.txt")
    ...
    Private Sub pacman_Resize(sender As System.Object, e As System.EventArgs) Handles MyBase.Resize
        If Me.WindowState = FormWindowState.Minimized Then
            aero.pacmanbuttonsmall.Visible = True
        End If
        If Me.WindowState = FormWindowState.Normal Then
            aero.pacmanbuttonsmall.Visible = False
        End If
    End Sub
End Class
