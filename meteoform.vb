...
Public Class meteoform
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        wb.Visible = True
        wb.Url = New Uri("http://www.ilmeteo.it/meteo.php?citta_input=" & ComboBox1.SelectedItem)
    End Sub
    ...
    Private Sub meteoform_Resize(sender As System.Object, e As System.EventArgs) Handles MyBase.Resize
        If Me.WindowState = FormWindowState.Minimized Then

            aero.meteobuttonsmall.Visible = True
        End If
        If Me.WindowState = FormWindowState.Normal Then

            aero.meteobuttonsmall.Visible = False
        End If
    End Sub

    Private Sub meteoform_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
